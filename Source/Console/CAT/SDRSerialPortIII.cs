...
namespace PowerSDR
{
	public class SDRSerialPort1
	{
		
        public static event SerialRXEventHandler serial_rx_event1; // ke9ns add for rotor port
		...
		public SDRSerialPort1(int portidx)
		{
            ...
            commPort.DataReceived += new SerialDataReceivedEventHandler(this.SerialReceivedData1);
        ...
        // ke9ns add
        void SerialReceivedData1(object source, SerialDataReceivedEventArgs e)
        {
            serial_rx_event1(this, new SerialRXEvent(commPort.ReadExisting()));
